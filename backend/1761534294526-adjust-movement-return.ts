...
export class AdjustMovementReturn1761534294526 implements MigrationInterface {
    name = 'AdjustMovementReturn1761534294526'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ef0d633970e11cdabeb71150f9"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "processedBy"`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" DROP COLUMN "movementType"`);
        await queryRunner.query(`DROP TYPE "public"."inventory_movements_movementtype_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "tenantId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "products" ADD "tax" numeric(5,2) DEFAULT '19'`);
        await queryRunner.query(`ALTER TABLE "products" ADD "unit_cost" numeric(12,2) DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "products" ADD "cost_per_gram" numeric(12,4) DEFAULT '0'`);
        await queryRunner.query(`CREATE TYPE "public"."products_weight_unit_enum" AS ENUM('GRAM', 'KILO', 'POUND')`);
        await queryRunner.query(`ALTER TABLE "products" ADD "weight_unit" "public"."products_weight_unit_enum" DEFAULT 'GRAM'`);
        await queryRunner.query(`ALTER TABLE "taxes" ADD "tenantId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "changeAmount" numeric(12,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "processedById" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "inventory_movements" ADD "tenantId" uuid NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."inventory_movements_type_enum" AS ENUM('INITIAL', 'PURCHASE', 'SALE', 'RETURN_CUSTOMER', 'RETURN_SUPPLIER', 'ADJUSTMENT', 'TRANSFER_IN', 'TRANSFER_OUT', 'DAMAGE', 'EXPIRY')`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" ADD "type" "public"."inventory_movements_type_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "inventory_stock" ADD "tenantId" uuid NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" ALTER COLUMN "address" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "tenants" ALTER COLUMN "phone" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "taxes" ADD CONSTRAINT "FK_3b850d0c8c3b744f80f3959a2fe" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales" DROP CONSTRAINT "FK_3a92cf6add00043cef9833db1cd"`);
        await queryRunner.query(`ALTER TABLE "taxes" DROP CONSTRAINT "FK_3b850d0c8c3b744f80f3959a2fe"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" ALTER COLUMN "phone" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "tenants" ALTER COLUMN "address" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "inventory_movements" DROP COLUMN "type"`);
        await queryRunner.query(`DROP TYPE "public"."inventory_movements_type_enum"`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" DROP COLUMN "tenantId"`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "processedById"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP COLUMN "changeAmount"`);
        await queryRunner.query(`ALTER TABLE "taxes" DROP COLUMN "tenantId"`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "weight_unit"`);
        await queryRunner.query(`DROP TYPE "public"."products_weight_unit_enum"`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "cost_per_gram"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."inventory_movements_movementtype_enum" AS ENUM('INITIAL', 'PURCHASE', 'SALE', 'RETURN_CUSTOMER', 'RETURN_SUPPLIER', 'ADJUSTMENT', 'TRANSFER_IN', 'TRANSFER_OUT', 'DAMAGE', 'EXPIRY')`);
        await queryRunner.query(`ALTER TABLE "inventory_movements" ADD "movementType" "public"."inventory_movements_movementtype_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payments" ADD "processedBy" character varying`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ef0d633970e11cdabeb71150f9" ON "inventory_movements" ("movementType") `);
